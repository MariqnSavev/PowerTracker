...
namespace BoxingAppDiploma.Controllers
{
    public class GoalsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Description,TargetDate,IsAchieved,UserId")] Goal goal)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Description,TargetDate,IsAchieved,UserId")] Goal goal)
        {
            if (id != goal.Id)
            {
                return NotFound();
