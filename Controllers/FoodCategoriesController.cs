...
namespace PowerTracker.Controllers
{
    public class FoodCategoriesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,NameOfCategorie")] FoodCategories foodCategory)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,NameOfCategorie")] FoodCategories foodCategory)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                {
                    if (!FoodCategoriesExists(foodCategory.Id))
                    {
                        return NotFound();
                    }
                    else
