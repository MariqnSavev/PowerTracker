...
CREATE TABLE [Diets] (
    ...
    CONSTRAINT [FK_Diets_AspNetUsers_UserId] FOREIGN KEY ([UserId]) REFERENCES [AspNetUsers] ([Id]) ON DELETE CASCADE
);
GO
...
CREATE INDEX [IX_Diets_UserId] ON [Diets] ([UserId]);
GO
...
VALUES (N'20250415184928_NewDatabaseUpdateApi23', N'6.0.35');
GO
